    ...
    <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul class="about-list list-unstyled open-sans-font">
                            <li> <span class="title">first name :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">Bramanta</span> </li>
                            <li> <span class="title">last name :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">Ari</span> </li>
                    ...
                    <div class="col-6">
                        <ul class="about-list list-unstyled open-sans-font">
                            <li> <span class="title">Address :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">Mataram</span> </li>
                            ...
                            <li> <span class="title">Email :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">Bramantaari@gmail.com</span> </li>
                            <li> <span class="title">Skype :</span> <span class="value d-block d-sm-inline-block d-lg-block d-xl-inline-block">none</span> </li>
        ...
        <div class="row">
            ...
            <div class="col-6 col-md-3 mb-3 mb-sm-5">
                ...
                <h6 class="text-uppercase open-sans-font text-center mt-2 mt-sm-4">Programing</h6>
            </div>
            <div class="col-6 col-md-3 mb-3 mb-sm-5">
                <div class="c100 p89">
                    <span>20%</span>
                ...
                <h6 class="text-uppercase open-sans-font text-center mt-2 mt-sm-4">Unity Engine</h6>
            </div>
            <div class="col-6 col-md-3 mb-3 mb-sm-5">
                <div class="c100 p70">
                    <span>15%</span>
            ...
            <div class="col-6 col-md-3 mb-3 mb-sm-5">
                ...
                <h6 class="text-uppercase open-sans-font text-center mt-2 mt-sm-4">Corel Draw</h6>
            </div>
                ...
                <div class="resume-box">
                    <ul>
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">Design <span class="place open-sans-font">Adhitama</span></h5>
                ...
                <div class="resume-box">
                    <ul>
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">Pendidikan Teknik Informatika <span class="place open-sans-font">Undiksha</span></h5>
                        ...
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">SMA <span class="place open-sans-font">SMA 1 Mataram</span></h5>
                        ...
                        <li>
                            ...
                            <h5 class="poppins-font text-uppercase">SMP <span class="place open-sans-font">SMP 1 Mataram</span></h5>
